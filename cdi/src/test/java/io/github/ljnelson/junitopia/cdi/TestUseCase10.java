...
class TestUseCase10 {
  ...
  @Inject
  private TestUseCase10 clientProxy;

  @Inject
  private TestUseCase10(final TestInfo testInfo) {
    super();
    assertNotNull(testInfo);
  }

  @BeforeAll
  private static final void setStaticFortyTwo(SeContainerInitializer sci) {
  ...
  @Test
  void testArgumentResolved(@Original final TestUseCase10 junitCreatedTestInstance,
    ...
    assertEquals("testArgumentResolved", ec.getRequiredTestMethod().getName());
